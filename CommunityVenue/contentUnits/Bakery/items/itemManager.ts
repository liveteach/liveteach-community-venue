...
export class ItemManager {
    ...
    spawnIngredients(){ 
        let eggs = new CarryItem("contentUnits/Bakery/models/items/eggs.glb", "Eggs", ItemType.eggs)
        eggs.setPlaceableArea(this.placeableAreas[0],eggs) 
        this.items.push(eggs)
        let sugar = new CarryItem("contentUnits/Bakery/models/items/casterSugar.glb", "Caster Sugar", ItemType.sugar)
        sugar.setPlaceableArea(this.placeableAreas[17],sugar) 
        this.items.push(sugar)
        let chocolate = new CarryItem("contentUnits/Bakery/models/items/chocolate.glb", "Chocolate", ItemType.chocolate)
        chocolate.setPlaceableArea(this.placeableAreas[25],chocolate) 
        this.items.push(chocolate)
        let cream = new CarryItem("contentUnits/Bakery/models/items/doubleCream.glb", "Double Cream", ItemType.cream)
        cream.setPlaceableArea(this.placeableAreas[3],cream) 
        this.items.push(cream)
        let flour = new CarryItem("contentUnits/Bakery/models/items/flour.glb", "Flour", ItemType.flour)
        flour.setPlaceableArea(this.placeableAreas[16],flour) 
        this.items.push(flour)
        let jam = new CarryItem("contentUnits/Bakery/models/items/jam.glb", "Jam", ItemType.jam)
        jam.setPlaceableArea(this.placeableAreas[23],jam) 
        this.items.push(jam)
        let butter = new CarryItem("contentUnits/Bakery/models/items/butter.glb", "Butter", ItemType.butter)
        butter.setPlaceableArea(this.placeableAreas[1],butter) 
        this.items.push(butter)

        let mixingBowl = new CarryItem("contentUnits/Bakery/models/items/mixingBowl.glb", "Mixing Bowl", ItemType.mixingBowl)
        mixingBowl.setPlaceableArea(this.placeableAreas[18],mixingBowl) 
        mixingBowl.setScale(0.75)
        this.items.push(mixingBowl)
        let whisk = new CarryItem("contentUnits/Bakery/models/items/whisk.glb", "Whisk", ItemType.whisk)
        whisk.setPlaceableArea(this.placeableAreas[24],whisk) 
        this.items.push(whisk)
        let spatula = new CarryItem("contentUnits/Bakery/models/items/spatula.glb", "Spatula", ItemType.spatula)
        spatula.setPlaceableArea(this.placeableAreas[22],spatula) 
        this.items.push(spatula)
        let bakingTin = new CarryItem("contentUnits/Bakery/models/items/bakingTin.glb", "Baking Tin", ItemType.bakingTin)
        bakingTin.setPlaceableArea(this.placeableAreas[19],bakingTin)
        bakingTin.setScale(0.75)
        this.items.push(bakingTin)

        let cakeStand = new CarryItem("contentUnits/Bakery/models/items/cakeStand.glb", "Cake Stand", ItemType.cakeStand)
