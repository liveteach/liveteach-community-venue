...
export class ItemManager {
    ...
    spawnIngredients(){ 
        let eggs = new CarryItem("models/bakery/items/eggs.gltf", "Eggs", ItemType.eggs)
        eggs.setPlaceableArea(this.placeableAreas[0],eggs) 
        this.items.push(eggs)
        let sugar = new CarryItem("models/bakery/items/casterSugar.gltf", "Caster Sugar", ItemType.sugar)
        sugar.setPlaceableArea(this.placeableAreas[17],sugar) 
        this.items.push(sugar)
        let chocolate = new CarryItem("models/bakery/items/chocolate.gltf", "Chocolate", ItemType.chocolate)
        chocolate.setPlaceableArea(this.placeableAreas[25],chocolate) 
        this.items.push(chocolate)
        let cream = new CarryItem("models/bakery/items/doubleCream.gltf", "Double Cream", ItemType.cream)
        cream.setPlaceableArea(this.placeableAreas[3],cream) 
        this.items.push(cream)
        let flour = new CarryItem("models/bakery/items/flour.gltf", "Flour", ItemType.flour)
        flour.setPlaceableArea(this.placeableAreas[16],flour) 
        this.items.push(flour)
        let jam = new CarryItem("models/bakery/items/jam.gltf", "Jam", ItemType.jam)
        jam.setPlaceableArea(this.placeableAreas[23],jam) 
        this.items.push(jam)
        let butter = new CarryItem("models/bakery/items/butter.gltf", "Butter", ItemType.butter)
        butter.setPlaceableArea(this.placeableAreas[1],butter) 
        this.items.push(butter)

        let mixingBowl = new CarryItem("models/bakery/items/mixingBowl.gltf", "Mixing Bowl", ItemType.mixingBowl)
        mixingBowl.setPlaceableArea(this.placeableAreas[18],mixingBowl) 
        mixingBowl.setScale(0.75)
        this.items.push(mixingBowl)
        let whisk = new CarryItem("models/bakery/items/whisk.gltf", "Whisk", ItemType.whisk)
        whisk.setPlaceableArea(this.placeableAreas[24],whisk) 
        this.items.push(whisk)
        let spatula = new CarryItem("models/bakery/items/spatula.gltf", "Spatula", ItemType.spatula)
        spatula.setPlaceableArea(this.placeableAreas[22],spatula) 
        this.items.push(spatula)
        let bakingTin = new CarryItem("models/bakery/items/bakingTin.gltf", "Baking Tin", ItemType.bakingTin)
        bakingTin.setPlaceableArea(this.placeableAreas[19],bakingTin)
        bakingTin.setScale(0.75)
        this.items.push(bakingTin)

        let cakeStand = new CarryItem("models/bakery/items/cakeStand.gltf", "Cake Stand", ItemType.cakeStand)
